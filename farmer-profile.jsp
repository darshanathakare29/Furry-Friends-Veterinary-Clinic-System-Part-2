			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<form role="form" action="EditFarmerProfile" method="post">
							<%
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblfarmer where uname='"+ session.getAttribute("uname") + "'");
								while (resultset.next()) {
							%>
							<div class="form-group">
								<label>Farmer Id</label> <input class="form-control"
									type="text" name="farmer_id"
									value="<%=resultset.getString("farmer_id")%>" readonly />
							</div>
							<div class="form-group">
								<label>Farmer Name</label> <input class="form-control" type="text"
									name="farmer_name" value="<%=resultset.getString("farmer_name")%>" readonly/>
									<br><strong>Note-</strong> <span class="label label-danger">You can not edit your farmer name because we set session on farmer name.</span>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Mobile No</label> <input class="form-control" name="mobile" id="mobile"
									type="text" value="<%=resultset.getString("mobile_no")%>" maxlength="10" onkeypress="return numberValidate(event)"/>
							</div>
							<div class="form-group">
								<label>Farmer User Name</label> <input class="form-control" name="uname"
...
<script>
	 $(document).ready(function() {
         $("#buttonValidate").click(function() {
             ...
             var uname = $("#uname").val();
             var upass = $("#upass").val();
             if (farmerName === "" || email === "" || mobile === "" || uname === "" || upass === "")
             {
