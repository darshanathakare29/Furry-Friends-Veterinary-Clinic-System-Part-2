...
<body class="host_version">
	<jsp:include page="client-side-header.jsp"></jsp:include><br>
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-6">
				<image src="images/client-review.png" style="width:400px;height:290px;">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-6">
				<%
				...
				%>
				<div class="alert alert-success" id="success">Review submitted successfully.</div>
				<%
					}
				%>
						...
						<form role="form" action="AddReviews" method="post" name=''>
							<div class="form-row">
								<div class="form-group col-md-12">
									<label for="feedback">Client Name</label>
									<input type="text" class="form-control" id="clientName" name="clientName"
										placeholder="Client Name" value="<%=session.getAttribute("client_name")%>" readonly>
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12">
