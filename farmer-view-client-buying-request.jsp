...
<body class="host_version">
	...
	<div class="container-fluid">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">View Clients Pet/Animal Buying Request</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				...
				%>
				<div class='alert alert-success' id="success">Farmer approve request
					successfully.</div>
				<%
					}
				%>
				<div class="panel panel-primary shadow p-3 mb-5">
					<div class="panel-heading">View Clients Pet/Animal Buying
						Request</div>
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<%
									ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblbuyrequest where farmer_name='" + session.getAttribute("farmer-name") + "'");
								...
								<tbody>
									<tr class="default">
										...
										<td><%=resultset.getString("client_mobile")%></td>
										...
										%>
										<td><a
											href="ApproveClientBuyingRequest?requestId=<%=resultset.getString("request_id")%>"
											class="btn btn-success">Approve Request</a></td>
										<%
											}
										%>
									</tr>
