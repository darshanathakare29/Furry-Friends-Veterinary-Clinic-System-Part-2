...
<body class="host_version">
	...
	<div class="container-fluid">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">View Request For Consult</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				...
				%>
				<div class='alert alert-success' id="success">Response submitted
					successfully.</div>
				<%
					}
				%>
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<%
									ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblsymptoms");
								...
								<tbody>
									<tr class="default">
										...
										<td><image src="uploads/<%=resultset.getString("disease_image_name")%>"
										...
										<td><a href="doctor-give-response-to-user.jsp?id=<%=resultset.getString("id")%>" class="btn btn-info">Give Reponse</a></td>
									</tr>
								</tbody>
								<%
									}
