	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/farmer-login.png" style="width:400px;height:350px;">
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="panel panel-primary shadow p-6 mb-8">
					<div class="panel-heading">Farmer Login</div>
					...
					%>
						<form action="FarmerLogin" method="post">
							...
							<a class="for-pwd" href="farmer-register.jsp">New Farmer Register</a>
						</form>
					</div>
				</div>
			</div>
