			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="DoctorChangePassword" method="post">
							<%
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tbldoctor where uname='"+ session.getAttribute("uname") + "'");
