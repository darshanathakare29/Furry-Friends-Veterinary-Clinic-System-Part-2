			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<form role="form" action="EditClientProfile" method="post">
							<%
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblclient where uname='"+ session.getAttribute("uname") + "'");
								while (resultset.next()) {
							%>
							<div class="form-group">
								<label>Client Id</label> <input class="form-control"
									type="text" name="cid"
									value="<%=resultset.getString("client_id")%>" readonly />
							</div>
							<div class="form-group">
								<label>Client Name</label> <input class="form-control" type="text"
									name="client_name" value="<%=resultset.getString("client_name")%>" onkeypress="return lettersValidate(event)" readonly/>
								<br><strong>Note-</strong> <span class="label label-danger">We can not edit client name because we set session on client name.</span>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Client User Name</label> <input class="form-control" name="uname"
...
<script>
	 $(document).ready(function() {
         $("#buttonValidate").click(function() {
             ...
             var uname = $("#uname").val();
             var upass = $("#upass").val();
             if (cName === "" || email === "" || mobile === "" || uname === "" || upass === "")
             {
