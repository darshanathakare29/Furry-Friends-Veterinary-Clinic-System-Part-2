...
<body class="host_version">
	...
	<div class="container-fluid">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">View Payments</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-primary shadow p-3 mb-5">
					<div class="panel-heading">View Payments</div>
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<%
									ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tblresponse where doctor_id='" + session.getAttribute("doctor-id") + "'");
