	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				%>
				<div class="alert alert-success" id="success">Your profile
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="EditDoctorProfile" method="post">
							<%
								ResultSet resultset = DatabaseConnection
									.getResultFromSqlQuery("select * from tbldoctor where uname='" + session.getAttribute("uname") + "'");
							while (resultset.next()) {
							%>
							<div class="form-group">
								<label>Doctor Id</label> <input class="form-control" type="text"
									name="doctor_id" value="<%=resultset.getString("doctor_id")%>"
									readonly />
							</div>
							<div class="form-group">
								<label>Doctor Name</label> <input class="form-control"
									type="text" name="doctor_name"
									value="<%=resultset.getString("doctor_name")%>" readonly /> <br>
								<strong>Note-</strong> <span class="label label-danger">You
									can not edit your doctor name because we set session on your
									name.</span>
							</div>
							<div class="form-group">
								<label>Department</label> <input class="form-control"
									name="department" id="department" type="text"
									value="<%=resultset.getString("department")%>" />
							</div>
							<div class="form-group">
								<label>Fees</label> <input class="form-control" name="fees"
									id="fees" type="text"
									value="<%=resultset.getString("doctor_fees")%>" />
							</div>
							<div class="form-group">
								<label>Doctor User Name</label> <input class="form-control"
...
<script>
	 $(document).ready(function() {
         $("#buttonValidate").click(function() {
             ...
             var uname = $("#uname").val();
             var upass = $("#upass").val();
             if (doctorName === "" || department === "" || fees === "" || uname === "" || upass === "")
             {
                 $("#doctorName").css("border-color", "red");
                 $("#department").css("border-color", "red");
                 $("#fees").css("border-color", "red");
