	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				%>
				<div class='alert alert-success' id="success">Animal buys sucessfully.</div>
				<%
					}
				%>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr class="default">
										...
										%>
										<td><a href="buy-animal.jsp?animalId=<%=resultset.getString("animal_id")%>&animalName=<%=resultset.getString("animal_name")%>&animalPrice=<%=resultset.getString("price")%>&farmerName=<%=resultset.getString("farmer_name")%>"
											class="btn btn-primary">Buy Animal</a></td>
										<%
											} else {
										%>
