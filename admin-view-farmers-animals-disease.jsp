...
<body class="host_version">
	...
	<div class="container-fluid">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">View Farmer Animal Disease</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				...
				%>
				<div class='alert alert-success' id="success">Assign doctor
					successfully.</div>
				<%
					}
				%>
				<div class="panel panel-danger shadow p-3 mb-5">
					<div class="panel-heading">View Farmer Animal Disease</div>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr class="default">
										...
										<td><a
											href="admin-assign-doctor-to-farmer-animal.jsp?id=<%=resultset.getString("id")%>"
											class="btn btn-warning">Assign Doctor</a></td>
									</tr>
								</tbody>
								<%
									}
