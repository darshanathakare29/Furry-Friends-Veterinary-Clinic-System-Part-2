	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/farmer-account.png"
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				%>
				<div class="alert alert-success" id="success">Farmer account
					created successfully.</div>
				<%
					}
				%>
				<div class="panel panel-primary">
					<div class="panel-heading">Create Farmer Account</div>
					<div class="panel-body">
						<form role="form" action="FarmerAccountCreate" method="post"
							name="registerForm" id="form">
							<div class="form-group">
								<label>Farmer Id</label>
								<%
									String farmerId = DatabaseConnection.generateFarmerId();
								%>
								<input class="form-control" type="text" value="<%=farmerId%>"
									name="farmerId" readonly />
							</div>
							<div class="form-group">
								<label>Farmer Name</label> <input class="form-control"
									type="text" name="farmerName" id="farmerName" placeholder="Farmer Name" onkeypress="return lettersValidate(event)"/>
							</div>
							<div class="form-group">
								<label>Email Id</label> <input class="form-control" type="text"
									name="emailId" id="emailId" onblur="ValidateEmail()" placeholder="Email Id" />
							</div>
							<div class="form-group">
							...
							<button type="submit" class="btn btn-info" id="buttonValidate">Create
								Account</button>
							<a class="for-pwd" href="farmer-login.jsp">Already
