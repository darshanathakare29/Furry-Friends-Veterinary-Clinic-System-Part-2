	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/client-account.png"
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				%>
				<div class="alert alert-success" id="success">Client account
					created successfully.</div>
				<%
					}
				%>
				<div class="panel panel-info">
					<div class="panel-heading">Create Client Account</div>
					<div class="panel-body">
						<form role="form" action="AccountCreate" method="post" name="clientForm" id="form">
							<div class="form-group">
								<label>Client Id</label>
								<%
									String clientId = DatabaseConnection.generateClientId();
								%>
								<input class="form-control" type="text" value="<%=clientId%>"
									name="clientId" id="clientId" readonly />
							</div>
							<div class="form-group">
								<label>Client Name</label> <input class="form-control"
									type="text" name="clientName" id="clientName" placeholder="Client Name" onkeypress="return lettersValidate(event)"/>
							</div>
							<div class="form-group">
							...
							<button type="submit" class="btn btn-info" id="buttonValidate">Create
								Account</button>
							<a class="for-pwd" href="client-login.jsp">Already
