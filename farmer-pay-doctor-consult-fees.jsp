...
<body class="host_version">
	...
	<div class="container">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">Pay Doctor Fees</h4>
			</div>
		</div>
		<%
			String responseId = request.getParameter("id");
			String farmerName = request.getParameter("farmerName");
			String doctorName = request.getParameter("doctorName");
			int doctorFees = Integer.parseInt(request.getParameter("doctorFees"));
			String doctorResponse = request.getParameter("doctorResponse");
		%>
		<div class="row">
			<div class="col-md-5 col-sm-5 col-xs-12">
				<img src="images/doctor-fees.jpg"
					style="width: 400px; height: 400px;">
			</div>
			<div class="col-md-7 col-sm-7 col-xs-12">
				<div class="panel panel-primary">
					<div class="panel-heading">Pay Doctor Fees</div>
					<div class="panel-body">
						<form role="form" action="PayDoctorConsultCharges" method="post">
							<div class="form-group">
								<label>Response Id</label> <input type="text"
									class="form-control" name="responseId" value="<%=responseId%>" readonly>
							</div>
							<div class="form-group">
								<label>Farmer Name</label>
								<input type="text" name="farmerName" class="form-control" value="<%=farmerName %>" readonly>
							</div>
							<div class="form-group">
								<label>Doctor Name</label> <input class="form-control"
									type="text" name="doctorName" value="<%=doctorName %>" readonly/>
							</div>
							<div class="form-group">
								<label>Doctor Response</label> <input class="form-control"
									type="text" name="doctorResponse" value="<%=doctorResponse %>" readonly/>
							</div>
							<div class="form-group">
								<label>Doctor Fees</label> <input class="form-control"
									type="text" name="doctorFees" value="<%=doctorFees %>" readonly/>
							</div>
							<div class="form-group">
							...
							<br>
							<button type="submit" class="btn btn-info" id="buttonValidate">Pay Charges</button>
						</form>
					</div>
				</div>
			</div>
